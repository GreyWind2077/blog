...
<div id="write" v-title :data-title="title">
   ...
   <div class="ui right aligned container">
            <button class="ui teal submit button"  @click="publishShow">发布</button>
            <button class="ui secondary button"  @click="cancel">取消</button>
	</div>	
 ...
 <el-container>
      ...
      <el-dialog title="摘要 分类 标签"
        ...
        <div slot="footer" class="dialog-footer">
          <button class="ui secondary button" @click="publishVisible = false">取 消</button>
          <button class="ui teal submit button" type="primary" @click="publish('articleForm')">发布</button>
        </div>
      </el-dialog>
